...
description: "How to onboard your validator on DevNet, TestNet, and MainNet via a Super Validator sponsor"
---
...
Join the `#validator-operations` channel hosted by the `Canton Foundation` using Slack Connect: [https://daholdings.slack.com/archives/C08AP9QR7K4](https://daholdings.slack.com/archives/C08AP9QR7K4). Your Slack workspace may allow you to browse to this channel, or you can ask your SV sponsor to send you an invitation.

### Mailing Lists

You can sign up for various mailing lists provided by the `Canton Foundation`. To do so, first create an account at [https://groups.io/](https://groups.io/) and then log in at [https://lists.sync.global/](https://lists.sync.global/). We recommend the following lists:
