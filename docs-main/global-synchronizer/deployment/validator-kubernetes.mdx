...
- **TRUSTED_SCAN_URL** — The scan URL of an SV that you trust and that is reachable by your validator, often your SV sponsor. This should be of the form <a href="https://scan.sv-1.dev.global.canton.network.YOUR_SV_SPONSOR">https://scan.sv-1.dev.global.canton.network.YOUR_SV_SPONSOR</a>, e.g., for the Global Synchronizer Foundation SV it is <a href="https://scan.sv-1.dev.global.canton.network.sync.global">https://scan.sv-1.dev.global.canton.network.sync.global</a>.
