---
title: "3.5.15"
description: "Canton 3.5.15 release notes."
---
...
This is a release that officially marks CantonBFT as GA for dedicated synchronizers.
It contains a number of improvements for CantonBFT, traffic enforcement app and resource management.

### CantonBFT GA

CantonBFT is now GA for dedicated synchronizers, and it is currently undergoing Canton Network production testing as part of the roadmap to Global Synchronizer adoption.
