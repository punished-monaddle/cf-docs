...
sidebarTitle: "/v0/events/:update_id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Returns the event with the given update_id. An event bears some combination of a transaction, a contract reassignment, and a verdict.</p>
