---
title: "GET /v0/top-validators-by-purchased-traffic"
...
sidebarTitle: "/v0/top-validators-by-purchased-traffic (removed)"
---
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">GET /v0/top-validators-by-purchased-traffic</h1>
...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/v0/top-validators-by-purchased-traffic</code>
</div>
...
<dl class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    <dt>Operation ID</dt>
    <dd>getTopValidatorsByPurchasedTraffic</dd>
  </div>
...
<div class="x2mdx-ref-fields">
  ...
  <div class="x2mdx-ref-field-row">
    <div class="x2mdx-ref-field-main">
      <code class="x2mdx-ref-field-name">validatorsByPurchasedTraffic</code>
      <span class="x2mdx-ref-type-badge">ValidatorPurchasedTraffic[]</span>
...
const response = await fetch('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-purchased-traffic', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-purchased-traffic',
...
func main() {
  req, _ := http.NewRequest("GET", "https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-purchased-traffic", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-purchased-traffic"))
...
uri = URI('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-purchased-traffic')
