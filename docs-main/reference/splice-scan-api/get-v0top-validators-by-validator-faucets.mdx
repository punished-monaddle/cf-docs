---
title: "GET /v0/top-validators-by-validator-faucets"
...
sidebarTitle: "/v0/top-validators-by-validator-faucets (removed)"
---
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">GET /v0/top-validators-by-validator-faucets</h1>
...
<div class="x2mdx-ref-badges">
  ...
  <a class="x2mdx-ref-badge x2mdx-ref-badge--removed" href="#history-removed-0-6-6">Removed in 0.6.6</a>
...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/v0/top-validators-by-validator-faucets</code>
</div>


<p><strong>Removed in 0.6.6.</strong> Historical definition from 0.6.5.</p>
...
<dl class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    <dt>Operation ID</dt>
    <dd>getTopValidatorsByValidatorFaucets</dd>
  </div>
...
<div class="x2mdx-ref-fields">
  ...
  <div class="x2mdx-ref-field-row">
    <div class="x2mdx-ref-field-main">
      ...
      <span class="x2mdx-ref-type-badge">integer (int32)</span>

      <span class="x2mdx-ref-required-badge">required</span>

    </div>

    <div class="x2mdx-ref-field-description">Maximum number of validator records that may be returned in the response</div>
...
<div class="x2mdx-ref-fields">
  ...
  <div class="x2mdx-ref-field-row">
    <div class="x2mdx-ref-field-main">
      <code class="x2mdx-ref-field-name">validatorsByReceivedFaucets</code>
      <span class="x2mdx-ref-type-badge">ValidatorReceivedFaucets[]</span>

      <span class="x2mdx-ref-required-badge">required</span>

    </div>

    <div class="x2mdx-ref-field-description">Up to `limit` validators, sorted greatest number of rounds collected first</div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--removed" id="history-removed-0-6-6">
    <div class="x2mdx-ref-history-event-head">
      <span class="x2mdx-ref-history-event-label">Removed in</span>
      <code class="x2mdx-ref-history-event-version">0.6.6</code>
    </div>

    <p class="x2mdx-ref-history-event-detail">Last available in 0.6.5. Retained for historical reference.</p>
...
const response = await fetch('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-validator-faucets', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-validator-faucets',
...
func main() {
  req, _ := http.NewRequest("GET", "https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-validator-faucets", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-validator-faucets"))
...
uri = URI('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/top-validators-by-validator-faucets')
