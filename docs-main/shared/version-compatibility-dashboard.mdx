...
export const componentDescriptions = {
  splice: { text: 'Canton Network infrastructure including validator apps, wallet, and governance tools.', link: 'https://github.com/digital-asset/decentralized-canton-sync/releases', linkText: 'View releases' },
  canton: { text: 'Canton ledger software (participants, sequencers, mediators).', link: 'https://github.com/digital-asset/canton/releases', linkText: 'View releases' },
  damlSdk: { text: 'Daml SDK for building, compiling, and testing smart contracts.', link: 'https://github.com/digital-asset/dpm-assembly/releases', linkText: 'View releases' },
...
<Info>Last Updated: {lastUpdatedLabel}</Info>
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          {[
            ...
            { name: 'Splice Releases', url: 'https://github.com/digital-asset/decentralized-canton-sync/releases' },
            { name: 'Canton Releases', url: 'https://github.com/digital-asset/canton/releases' },
            { name: 'Daml SDK Releases', url: 'https://github.com/digital-asset/dpm-assembly/releases' },
